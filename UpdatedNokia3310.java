...
public class UpdatedNokia3310 {
	...
	String menu= """
		...
		int userInput2 = scanner.nextInt();
			...
			case 3: {
				String addnames= "Add Names";
				System.out.print(addnames+"");
				break;
			...
			System.out.print(optiondropdown);		
				...
				int choice = scanner.nextInt();
					...
					switch(choice){
						case 1: {
							String typeofview= "Type Of View";
						...
						case 2: {
							String memorystatus= "Memory Status";
		...
		switch(userInput3) {
			...
			case 1: {
				String writemessages= "Write Messages";
			...
			case 4: {
				String picturemessages= "Picture Messages";
			...
			case 7: {
				...
				switch(choice2){
					case 1: {
						String messagecentrenumber= "Message Centre Number";
						System.out.println(messagecentrenumber+"");
						break;
						
						}

						case 2: {
							String messagesentas= "Message Sent As";
						...
						case 3: {
							String messagevalidity= "Message Validity";
				...
				switch(choice3){
					case 1: {
						String deliveryreports= "Delivery Reports";
					...
					case 2: {
						String replyviasamecentre= "Reply Via Same Centre";
						System.out.println(replyviasamecentre+"");
						break;

						}

					case 3: {
						String charactersupport= "Character Support";
				...
				String infoservice= "Info Service";
				...
				case 9: {
					...
					switch(choice5) {
						case 1: {
							String voicemailboxnumber1= "Voice Mailbox Number";
							System.out.print(voicemailboxnumber1+"");
							break;
				...
				String servicecommandeditor= "Service Command Editor";
				...
				break;
					...
					case 2: {
				String recievedcalls= "Recieved Calls";
				System.out.print(recievedcalls+"");
				break;
						
						}

					case 3: {
				String diallednumbers= "Dialled Numbers";
				...
				break;
					...
					case 4: {
				String eraserecentcalllists= "Erase Recent Call Lists";
				...
				break;
					...
					case 5: {
				String showcallduration= "Show Call Duration";
				System.out.print(showcallduration+"");
							...
							switch(choice11) {
									...
									String allcallsduration= "All Calls' Duration";
									...
									String receivedcallsduration= "Received Calls' Duration";
									...
									String dialledcallsduration= "Dialled Calls' Duration";
									...
									String cleartimers= "Clear Timers";
					...
					case 6: {
				String showcallcost= "Show Call Cost";
				System.out.print(showcallcost+"");
							...
							switch(choice12) {
									...
									String lastcallcost= "Last Call Cost";
									...
									String allcallscost= "All Calls' Cost";
									...
									String clearcounters= "Clear Counters";
					...
					case 7: {
				String callcostsettings= "Call Cost Settings";
				System.out.print(callcostsettings+"");
							...
							switch(choice13) {
									...
									String callcostlimit= "Call Cost Limit";
									...
									String showcostin= "Show Cost In";
					...
					case 8: {
				String prepaidcredit= "Prepaid Credit";
				System.out.print(prepaidcredit+"");
							...
							switch(choice14) {
									...
									String prepaidcredit1= "Prepaid Credit";
									System.out.print(prepaidcredit1+"");
									break;
		...
		switch(choicetone) {
			...
			case 1: {	
				String ringingtone= "Ringing Tone";
				System.out.print(ringingtone+"");
				break;					
				}

			case 2: {	
				String ringingvolume= "Ringing Volume";
				System.out.print(ringingvolume+"");
				break;					
				}

			case 3: {	
				String incomingcallalert= "Incoming Call Alert";
			...
			case 5: {	
				String messagealerttone= "Message Alert Tone";
				System.out.print(messagealerttone+"");
				break;					
					}

			case 6: {	
				String keypadstones= "Keypads Tones";
				System.out.print(keypadstones+"");
				break;					
					}

			case 7: {	
				String warningandgametones= "Warning And Game Tones";
				System.out.print(warningandgametones+"");
				break;					
					}

			case 8: {	
				String vibratingalert= "Vibrating Alert";
				System.out.print(vibratingalert+"");
				break;					
					}
	
			case 9: {	
				String screensaver= "Screen Saver";
					...
					switch (choicesettings){
						...
						switch(choicephone){
							...
							case 6: {	String confirmsimserviceactions= "Confirm Sim Service Actions";
									System.out.print(confirmsimserviceactions+"");
									break;	
										}
									}break;
					...
					case 11: {	String clockdropdown= """
						...
						switch(choiceclock1){
							...
							case 6: {	String autoupdateofdateandtime= "Auto Update Of Date And Time";
									System.out.print(autoupdateofdateandtime+"");
									break;	
										}
